      ...
      <div className="flex items-center justify-between max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="size-8 flex items-center justify-center bg-white dark:bg-zinc-800 shadow rounded-lg transition-all duration-300 hover:scale-105 active:scale-95"
          >
            {theme === "light" ? (
              <MoonIcon className="size-4 text-gray-800 dark:text-gray-200 transition-colors duration-300" />
            ) : (
